import { PrimaryKey, Property, Entity, defineConfig, RequestContext, serialize } from "@mikro-orm/mysql";
...
const _useOn = (eventName, eventQrl) => {
  if (eventQrl) {
    ...
    "string" == typeof eventName ? elCtx.li.push([normalizeOnProp(eventName), eventQrl]) : elCtx.li.push(...eventName.map((name) => [normalizeOnProp(name), eventQrl])), elCtx.$flags$ |= HOST_FLAG_NEED_ATTACH_LISTENER;
  }
};
...
const useTaskQrl = (qrl, opts) => {
  ...
  set(true), qrl.$resolveLazy$(containerState.$containerEl$), elCtx.$tasks$ || (elCtx.$tasks$ = []), elCtx.$tasks$.push(task), waitAndRun(iCtx, () => runTask(task, containerState, iCtx.$renderCtx$)), isServerPlatform() && useRunTask(task, opts == null ? void 0 : opts.eagerness);
};
...
const ComponentSerializer = /* @__PURE__ */ serializer({
  ...
  $fill$: (component, getObject) => {
    ...
    ((_a2 = qrl.$capture$) == null ? void 0 : _a2.length) && (qrl.$captureRef$ = qrl.$capture$.map(getObject), qrl.$capture$ = null);
  }
});
...
let Todo = class Todo2 extends Record {
  constructor(details, completed = false) {
    super();
...
const DbName = z.string().min(1).max(64).regex(/[a-z0-9$~_-]+/i);
const NodeEnv = z.union([
  z.literal("production"),
  z.literal("development"),
  z.literal("test")
]);
const Debug = NodeEnv.default("development").transform((value) => [
  "development",
  "debug"
].includes(value));
const Host = z.string().min(3).optional();
const PortString = z.string().superRefine((value, ctx) => {
  if (!/^[0-9]+$/.test(value))
    ctx.addIssue({
      validation: "regex",
...
z.number().int().min(0).max(2 ** 16 - 1);
const Port = z.union([
  z.number(),
  PortString
]).transform((value) => value ? Number(value) : void 0).optional();
const User = z.string().min(3).regex(/^[a-z0-9_-]+$/i).default("root");
...
async function getOrm() {
  if (!cached)
    throw new Error("Mikro ORM is not initialized. You need to call initOrm(config) first.");
  return cached;
}
async function runInContext(fn) {
  const orm = await getOrm();
  return RequestContext.create(orm.em, () => fn(orm));
}
const withOrm = (fn) => async (...args) => runInContext((orm) => fn(orm, ...args));
const onRequest = async ({ env }) => {
  await initOrm({
    debug: env.get("NODE_ENV"),
...
const onGet$1 = async ({ cacheControl }) => {
  cacheControl({
...
const PluginPlugin = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  onGet: onGet$1,
  onRequest
}, Symbol.toStringTag, { value: "Module" }));
...
const s_AXfkOub3zOE = () => /* @__PURE__ */ _jsxQ("main", null, {
  class: "w-screen h-screen flex select-none"
}, /* @__PURE__ */ _jsxQ("div", null, {
  class: "flex flex-1 flex-col"
}, /* @__PURE__ */ _jsxC(Slot, null, 3, "XE_0"), 1, null), 1, "XE_1");
const RootLayout = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_AXfkOub3zOE, "s_AXfkOub3zOE"));
...
const routeActionQrl = (actionQrl, ...rest) => {
  ...
  function action() {
    ...
    const state = useStore(() => {
      ...
      if (value && (value == null ? void 0 : value.id) === id) {
    ...
    const submit = /* @__PURE__ */ inlinedQrl(s_A5bZC7WO00A, "s_A5bZC7WO00A", [
      currentAction,
      id,
      loc,
      state
...
const s_p9MSze0ojs4 = async (_, form) => {
...
const s_Nk9PlpjQm9Y = (props) => {
  ...
  return /* @__PURE__ */ _jsxS("form", {
    ...
    onSubmit$: /* @__PURE__ */ inlinedQrl(s_p9MSze0ojs4, "s_p9MSze0ojs4", [
      nav
    ])
  }, {
    action: "get",
...
const GetForm = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_Nk9PlpjQm9Y, "s_Nk9PlpjQm9Y"));
const LuPlus = (props) => /* @__PURE__ */ _jsxS("svg", {
  ...props,
  children: [
...
const LuTrash2 = (props) => /* @__PURE__ */ _jsxS("svg", {
  ...props,
  children: [
    /* @__PURE__ */ _jsxQ("path", null, {
      d: "M3 6h18"
...
const TodoCompleted = z.boolean();
const TodoBase = z.object({
  details: z.string().min(1).max(255)
});
const TodoCreateInput = TodoBase.extend({
  completed: TodoCompleted.default(false)
});
const ID = z.string().uuid();
const Node2 = z.object({
  id: ID
});
const s_0KDLYDrBz0s = (props) => /* @__PURE__ */ _jsxQ("div", null, {
  class: _fnSignal((p0) => [
    "flex flex-row flex-1 shadow-md rounded-md p-5 bg-white border-neutral-200 dark:bg-neutral-800",
    p0.class
  ], [
    props
  ], '["flex flex-row flex-1 shadow-md rounded-md p-5 bg-white border-neutral-200 dark:bg-neutral-800",p0.class]')
}, /* @__PURE__ */ _jsxC(Slot, null, 3, "cK_0"), 1, "cK_1");
const Card = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_0KDLYDrBz0s, "s_0KDLYDrBz0s"));
const s_7lRcHnwBNNE = withOrm(async (orm, input, { error }) => {
  const todo = await orm.em.findOne(Todo, input.id);
  if (!todo)
    return error(404, "Todo could not be found");
  await orm.em.removeAndFlush(todo);
});
const useRemoveTodo = globalActionQrl(/* @__PURE__ */ inlinedQrl(s_7lRcHnwBNNE, "s_7lRcHnwBNNE"), zodQrl(/* @__PURE__ */ inlinedQrl(Node2, "s_ESeCRcZjrUM")));
const s_NBYS2QjSJGQ = (props) => {
  const remove = useRemoveTodo();
  return /* @__PURE__ */ _jsxC(Card, {
    children: [
      /* @__PURE__ */ _jsxQ("div", null, {
        class: "flex flex-1"
      }, _fnSignal((p0) => p0.todo.details, [
        props
      ], "p0.todo.details"), 3, null),
      /* @__PURE__ */ _jsxC(Form, {
        action: remove,
        children: [
          /* @__PURE__ */ _jsxQ("input", null, {
            name: "id",
            type: "hidden",
            value: _fnSignal((p0) => p0.todo.id, [
              props
            ], "p0.todo.id")
          }, null, 3, null),
          /* @__PURE__ */ _jsxQ("button", null, {
            disabled: _fnSignal((p0) => p0.isRunning, [
              remove
            ], "p0.isRunning")
          }, /* @__PURE__ */ _jsxC(LuTrash2, null, 3, "1h_0"), 1, null)
        ],
        [_IMMUTABLE]: {
          action: _IMMUTABLE
        }
...
const TodoCard = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_NBYS2QjSJGQ, "s_NBYS2QjSJGQ"));
const s_1zAzDsquF2k = withOrm(async (orm) => serialize(await orm.em.find(Todo, {}, {
  orderBy: {
    updatedAt: "desc"
  }
})));
const useGetTodos = routeLoaderQrl(/* @__PURE__ */ inlinedQrl(s_1zAzDsquF2k, "s_1zAzDsquF2k"));
const s_4NiW2aUPMik = withOrm(async (orm, { details, completed }) => {
  const todo = new Todo(details, completed);
  await orm.em.persistAndFlush(todo);
  return serialize(todo);
});
const useCreateTodo = routeActionQrl(/* @__PURE__ */ inlinedQrl(s_4NiW2aUPMik, "s_4NiW2aUPMik"), zodQrl(/* @__PURE__ */ inlinedQrl(TodoCreateInput, "s_n2XYNIIaq9A")));
const head = {
  title: "Qwik To-do"
};
const s_vHb0AY2MS70 = () => {
  ...
  return /* @__PURE__ */ _jsxQ("div", null, {
    class: "w-full p-5 flex flex-col gap-5 mobile:px-0 mobile:w-mobile mx-auto"
  }, [
    /* @__PURE__ */ _jsxQ("div", null, {
    ...
    /* @__PURE__ */ _jsxQ("div", null, {
        ...
        children: /* @__PURE__ */ _jsxC(Form, {
          ...
          children: [
            ...
            /* @__PURE__ */ _jsxQ("button", null, {
              ...
              type: "submit"
            }, /* @__PURE__ */ _jsxC(LuPlus, null, 3, "2m_0"), 1, null)
          ],
          class: "flex flex-1 gap-2 w-full",
          spaReset: true,
          [_IMMUTABLE]: {
            action: _IMMUTABLE,
            class: _IMMUTABLE,
      ...
      }, todos.value.map((todo) => /* @__PURE__ */ _jsxQ("li", null, null, /* @__PURE__ */ _jsxC(TodoCard, {
        todo
      }, 3, "2m_3"), 1, todo.id)), 1, null)
    ], 1, null)
  ], 1, "2m_4");
};
const TodoPage = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_vHb0AY2MS70, "s_vHb0AY2MS70"));
...
const routes = [
  ["/", [Layout, () => IndexRoute], "/", ["q-D5z-lxYq.js", "q-CAtsXEfr.js"]]
];
const menus = [];
